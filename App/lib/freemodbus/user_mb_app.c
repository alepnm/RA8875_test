...
/* SlaveID buferis */
uint8_t ucSlaveIdBuf[MB_FUNC_OTHER_REP_SLAVEID_BUF] = "QWERTYUIOPAS123456789ASDFGHJ";
...
eMBReportSlaveIdCB( UCHAR * pucRegBuffer, UCHAR ucNBytes ){
    ...
    eMBErrorCode    eErrCode = MB_ENOERR;
    UCHAR *         pusRegRepSlaveIdBuf = ucSlaveIdBuf;

    /* ruosiam siuntimo freima */
    memcpy( pucRegBuffer+3, pusRegRepSlaveIdBuf, MB_FUNC_OTHER_REP_SLAVEID_BUF );
