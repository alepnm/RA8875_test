...
#define BANK_NE1 0x60000000
#define BANK_NE2 0x64000000
#define BANK_NE3 0x68000000
#define BANK_NE4 0x6C000000


#define FMC_BANK_BASE  ((uint32_t)(BANK_NE1 | 0x08000000))
